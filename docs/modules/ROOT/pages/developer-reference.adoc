...
* Create a new annotation in https://github.com/quarkiverse/quarkiverse-github-app/tree/master/runtime/src/main/java/io/quarkiverse/githubapp/event[Quarkiverse GitHub App].
...
The Quarkiverse GitHub App extension supports the following features:
...
The Quarkiverse GitHub App extension provides an error handler that will log errors with as many details as possible.
...
The Quarkiverse GitHub App extension exposes the following configuration properties:
