...
A Quarkiverse GitHub App is a standard Quarkus application.

You can create one including the Quarkiverse GitHub App extension with the following command:
...
mvn io.quarkus:quarkus-maven-plugin:{quarkus-version}:create \
    ...
    -Dextensions="io.quarkiverse.githubapp:quarkiverse-github-app:{quarkiverse-github-app-version}" \
    -DnoExamples
----
...
[TIP]
====
Don't forget the backslashes at the lines of your private key.
====
...
You are done developing your first Quarkiverse GitHub App.
