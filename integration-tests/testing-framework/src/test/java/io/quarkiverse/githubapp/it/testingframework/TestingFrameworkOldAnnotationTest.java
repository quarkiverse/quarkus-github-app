...
@QuarkusTest
@GithubAppTest // Using the deprecated @GithubAppTest and not @GitHubAppTest on purpose
public class TestingFrameworkOldAnnotationTest {
    ...
    void ghObjectVerifyNoMoreInteractions() {
        ...
        assertThatThrownBy(assertion)
                ...
                .hasMessageContainingAll("No interactions wanted here:",
                        "-> at io.quarkiverse.githubapp.it.testingframework.TestingFrameworkOldAnnotationTest.lambda$ghObjectVerifyNoMoreInteractions$",
