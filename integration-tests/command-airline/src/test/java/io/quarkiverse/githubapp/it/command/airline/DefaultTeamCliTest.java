...
@QuarkusTest
@GitHubAppTest
public class DefaultTeamCliTest {

    @Test
    void testNoTeams() throws IOException {
        given()
                .github(mocks -> {
                ...
                .then().github(mocks -> {
                    ...
                    verifyCommandExecution(mocks, "hello from @default-team no-teams");
                });
    ...
    @Test
    void testTeam2() throws IOException {
        given()
                .github(mocks -> {
                    Set<GHTeam> teams = new LinkedHashSet<>();
                ...
                .then().github(mocks -> {
                    ...
                    verifyCommandExecution(mocks, "hello from @default-team team2");
                });
