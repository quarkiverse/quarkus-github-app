...
public class OpenTelemetryAttributes {
    ...
    // commands
    public static final AttributeKey<String> ERROR_TYPE = AttributeKey.stringKey("errorType");
    public static final AttributeKey<String> COMMAND_CLASS = AttributeKey.stringKey("command.class");
    public static final AttributeKey<String> COMMAND_LINE = AttributeKey.stringKey("command.commandLine");
    ...
    static void putCommonCommandAttributes(AttributesBuilder attributesBuilder, String commandClassName) {
        if (commandClassName != null) {
            attributesBuilder.put(COMMAND_CLASS, commandClassName);
        }
    }
    ...
    static void putCommandErrorAttributes(AttributesBuilder attributesBuilder, CommandErrorType errorType,
            String errorMessage) {
        attributesBuilder.put(OUTCOME, STATUS_FAILURE);
        attributesBuilder.put(ERROR_TYPE, errorType.name());
